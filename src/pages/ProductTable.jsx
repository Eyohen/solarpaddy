  ...
  return (
    <div className="bg-violet-50 min-h-[100vh] px-12 py-9">
      ...
      <div className="flex justify-between items-center mb-6 mt-9">
        ...
        <Link
          to="/createproduct"
          className="flex items-center gap-2 bg-black text-white px-4 py-1 rounded-lg hover:bg-gray-500 transition-colors"
        >
          <RiAddLine />
          Create New Product
        </Link>
        <Link
          to="/createbrand"
className="mt-1 flex items-center gap-2 border border-black text-black hover:text-white  px-4 py-1 rounded-lg hover:bg-black transition-colors"
        >
          <RiAddLine />
          Create New Brand
        </Link>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-sm font-medium text-gray-600">Product Number</th>
